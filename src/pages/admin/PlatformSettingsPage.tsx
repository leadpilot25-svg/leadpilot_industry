    ...
    <AdminLayout>
      <div className="px-6 py-7 max-w-2xl space-y-8">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">Configure how LeadPilot is deployed for your use case.</p>
        </div>
        ...
        >
          <div>
            <h2 className="text-sm font-semibold text-white">Deployment Mode</h2>
            <p className="mt-0.5 text-xs text-slate-500">Choose how this platform operates.</p>
          </div>
        ...
        <div
          ...
          style={{ background: '#161B22', border: '1px solid rgba(255,255,255,0.07)' }}
        >
          <h2 className="text-sm font-semibold text-white">Role Responsibilities</h2>
            ...
            {[
              ...
              >
                ...
                <div className="space-y-1">
                  {r.items.map(item => (
                    <p key={item} className="text-xs text-slate-300 flex items-center gap-1.5">
                      <span style={{ color: r.color }}>✓</span> {item}
                    </p>
                  ))}
                  {r.not.map(item => (
                    <p key={item} className="text-xs text-slate-600 flex items-center gap-1.5">
