  ...
  return (
    <AppLayout>
      <div className="px-4 py-6 sm:px-6 space-y-6">
        ...
        {/* Header */}
        <div>
          <h1 className="text-xl font-semibold text-white">Tarot & Healing Workspace</h1>
              ...
              <tbody className="divide-y divide-gray-800">
                ...
                {!loading && todaysSessions.map(lead => (
                  <tr key={lead.id} className="cursor-pointer transition-colors hover:bg-gray-800/30"
                    ...
                    <td className="px-4 py-3 text-sm text-gray-300">{cd(lead, 'session_type') || '—'}</td>
              ...
              <tbody className="divide-y divide-gray-800">
                ...
                {!loading && revenueTable.length > 0 && (
                  <tr className="border-t-2 border-gray-700 bg-gray-800/30">
                    ...
                    <td className="px-4 py-3 text-sm font-semibold text-white">{totalSessions}</td>
