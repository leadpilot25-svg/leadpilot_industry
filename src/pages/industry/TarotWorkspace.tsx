...
function GuidanceCard() {
  return (
    <div className="rounded-2xl border border-amber-200 bg-amber-50 p-5 text-center space-y-3">
      ...
      <div>
        <p className="text-sm font-semibold text-amber-900">Track sessions and revenue</p>
        <p className="text-xs text-amber-700 mt-1 leading-relaxed">Add session type and fee to your leads to see session counts, repeat clients, and total revenue.</p>
      </div>
      <div className="rounded-xl border border-amber-200 bg-white px-3 py-2">
        <p className="text-[10px] font-semibold text-amber-600 uppercase tracking-wide mb-1">Custom fields to fill</p>
        <p className="font-mono text-[11px] text-gray-600">session_type, session_fee, consultation_status</p>
      </div>
  ...
  return (
    <AppLayout>
      <div className="px-4 py-6 sm:px-6 space-y-6">
        ...
        {/* Header */}
        <div>
          <h1 className="text-xl font-semibold text-gray-900">My Business — Tarot</h1>
